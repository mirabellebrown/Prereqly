    ...
    <div className="space-y-6">
      ...
      <section>
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          ...
          >
            <div className="h-full rounded-[calc(var(--radius-panel)-1px)] bg-slate-950/90 p-5">
      ...
      <section className="panel border border-silver/25 bg-gradient-to-br from-silver/12 via-ucsb-navy to-slate-950 p-6">
